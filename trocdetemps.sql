...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  ven. 20 déc. 2019 à 11:15
...
CREATE TABLE IF NOT EXISTS `deal` (
  ...
  PRIMARY KEY (`idDeal`),
  KEY `Deal_Etat1_FK` (`idEtat`),
  KEY `idOffreUser1` (`idOffreUser1`,`idOffreUser2`),
  KEY `idOffreUser2` (`idOffreUser2`),
...
(4, '2018-08-17', 7, 2, 8, 6, 1, 1),
(5, '2018-08-31', 9, 8, 2, 5, 2, 5),
(6, '2018-09-11', 0, 0, 5, 2, 1, 2),
(7, '2018-12-12', 0, 2, 9, 2, 1, 1),
(8, '2019-05-23', 0, 0, 9, 2, 1, 1);
...
CREATE TABLE IF NOT EXISTS `demande` (
  ...
  KEY `Demande_Service_FK` (`idService`),
  KEY `Demande_User0_FK` (`idUser`)
...
CREATE TABLE IF NOT EXISTS `incompatible` (
  ...
  `idUserIncompatible` int(11) NOT NULL,
  `nomUserIncompatible` text NOT NULL
...
INSERT INTO `incompatible` (`idUser1`, `idUserIncompatible`, `nomUserIncompatible`) VALUES
(0, 0, ''),
(0, 0, ''),
(0, 0, ''),
(1, 2, ''),
...
CREATE TABLE IF NOT EXISTS `offre` (
  ...
  `idUser` int(11) NOT NULL,
  PRIMARY KEY (`idOffre`),
  KEY `Offre_Service_FK` (`idService`),
  KEY `idUser` (`idUser`)
...
CREATE TABLE IF NOT EXISTS `service` (
  ...
  KEY `Service_Categorie_FK` (`idCateg`)
